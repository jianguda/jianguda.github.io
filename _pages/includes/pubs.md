...
- ``ArXiv`` [Semantic-based Optimization for Repairing LLMs: Case Study on Code Generation](https://arxiv.org/abs/2503.12899)
<br> **Jian Gu**, Aldeida Aleti, Chunyang Chen, Hongyu Zhang
- ``ArXiv`` [A Semantic-based Layer Freezing Approach to Efficient Fine-Tuning of LMs](https://arxiv.org/abs/2406.11753)
<br> **Jian Gu**, Aldeida Aleti, Chunyang Chen, Hongyu Zhang
- ``ArXiv`` [Realizing Disentanglement in LM Latent Space via Vocabulary-Defined Semantics](https://arxiv.org/abs/2401.16184)
<br> **Jian Gu**, Aldeida Aleti, Chunyang Chen, Hongyu Zhang
- ``ArXiv`` [Focus-aware Neurons: Code LLMs with Selective Attention]()
<br> **Jian Gu**, Aldeida Aleti, Chunyang Chen, Hongyu Zhang
...
- ``Revision`` [Memory Augmentation Methods for Continuous Code Summarization]()
<br> **Jian Gu**, Harald C. Gall
- ``FSE'23`` [Towards Top-Down Deep Code Generation in Limited Scopes](https://dl.acm.org/doi/10.1145/3611643.3613076)
<br> **Jian Gu**, Harald C. Gall
