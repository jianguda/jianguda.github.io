...
- ``ArXiv`` [A Semantic-based Layer Freezing Approach to Efficient Fine-Tuning of Language Models](https://arxiv.org/abs/2406.11753)
<br> **Jian Gu**, Aldeida Aleti, Chunyang Chen, Hongyu Zhang
- ``ArXiv`` [On the Semantics of LM Latent Space: A Vocabulary-defined Approach](https://arxiv.org/abs/2401.16184)
<br> **Jian Gu**, Aldeida Aleti, Chunyang Chen, Hongyu Zhang
- ``Revision`` [Focus-aware Code LLMs: Coding with Selective Attention]()
<br> **Jian Gu**, Aldeida Aleti, Chunyang Chen, Hongyu Zhang
- ``ArXiv`` [Neuron Patching: Neuron-level Model Editing on Code Generation and LLMs](https://arxiv.org/abs/2312.05356)
<br> **Jian Gu**, Aldeida Aleti, Chunyang Chen, Hongyu Zhang
