...
<!-- TODO: append a paper list on LM semantics (03/04 2026) -->
<!-- ## Language Model Semantics -->

## Software Engineering for Machine Learning (SE4AI)
<!-- - ``ArXiv`` [SemRF: A Semantic Reference Frame for Residual-Stream Dynamics in Language Models]()
...
<br> **Jian Gu**, Aldeida Aleti, Chunyang Chen, Hongyu Zhang -->
- ``ACL'26`` [Cross-Scale Knowledge Transfer in Large Language Models through Latent Semantic Alignment](https://arxiv.org/abs/2510.24208)
<br> **Jian Gu**, Aldeida Aleti, Chunyang Chen, Hongyu Zhang
...
- ``FSE'23 (IVR)`` [Towards Top-Down Automated Development in Limited Scopes: A Neuro-Symbolic Framework from Expressibles to Executables](https://dl.acm.org/doi/10.1145/3611643.3613076)
<br> **Jian Gu**, Harald C. Gall
